  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Formulaire de contact pour me joindre en vue d'un entretien ou d'une future collaboration."
        />
        {/* Si tu veux empêcher l'indexation, décommente la ligne suivante */}
